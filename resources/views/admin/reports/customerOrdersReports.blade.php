...
<title>{{websiteTitle('Customer Order Reports')}}</title>
@endsection @push('css')
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Customer Order Reports</h3>
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="{{route('admin.reportsAll','customer-orders')}}"> <i class="fa-solid fa-rotate"></i> </a>
            ...
            <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <div id="accordion">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8; border-top: 0;">
                                    <div class="card-body">
                                        <form action="{{route('admin.reportsAll','customer-orders')}}">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mb-0">
                                                    <div class="form-group">
                                                       <select class="form-control" name="payment">
                                                            ...
                                                            <option value="unpaid">Unpid</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mb-0">
                                                ...
                                                <div class="col-md-4 mb-0">
                                                    <div class="input-group">
                                                        <input type="text" name="search" value="{{request()->search?request()->search:''}}" placeholder="Invoice, name, mobile, email" class="form-control {{$errors->has('search')?'error':''}}" />
                ...
                <div class="card">
                    <div class="card-header" style="border-bottom: 1px solid #e3ebf3;padding: 1rem;">
                        <h4 class="card-title" style="padding: 5px;">Customer Order Reports</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
