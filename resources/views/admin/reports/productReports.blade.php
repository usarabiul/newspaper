...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Product Reports</h3>
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a class="btn btn-outline-primary" href="{{route('admin.reportsAll','products')}}"> <i class="fa-solid fa-rotate"></i> </a>
        </div>
    </div>
</div>
                        ...
                        <div class="card-body">
                            <div id="accordion">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8; border-top: 0;">
                                    <div class="card-body">
                                        <form action="{{route('admin.reportsAll','products')}}">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-0">
                                                    <div class="form-group">
                                                        <input type="text" name="price" value="{{request()->price?request()->price:''}}" placeholder="Price <=" class="form-control {{$errors->has('price')?'error':''}}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-0">
                                                    <div class="form-group">
                                                        <input type="text" name="quantity" value="{{request()->quantity?request()->quantity:''}}" placeholder="Quantity <=" class="form-control {{$errors->has('quantity')?'error':''}}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-0">
                                                    <div class="form-group">
                            ...
                            <table class="table table-striped table-bordered dataex-html5-export">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@foreach($product->productCategories as $i=>$ctg){{$i==0?'':'-'}} {{$ctg->name}}@endforeach</td>
